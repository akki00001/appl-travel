...
const BaliHero: React.FC = () => {
  return (
    <div style={{ fontFamily: 'sans-serif' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '0.5rem', padding: '1rem' }}>
        <div style={{ gridColumn: '1 / 2', gridRow: '1 / 3' }}>
          <img src="/images/bali/01.jpg" alt="Ladakh" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0.5rem' }} />
        </div>
        <img src="/images/bali/02.jpg" alt="Destinations" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0.5rem' }} />
        <img src="/images/bali/03.jpg" alt="Stays" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0.5rem' }} />
        <img src="/images/bali/04.jpg" alt="Activity" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0.5rem' }} />
        <div style={{ position: 'relative' }}>
          <img src="/images/bali/05.jpg" alt="Sightseeing" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0.5rem' }} />
