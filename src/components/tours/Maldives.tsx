    ...
    <div style={{ fontFamily: 'sans-serif' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '0.5rem', padding: '1rem' }}>
        <div style={{ gridColumn: '1 / 2', gridRow: '1 / 3' }}>
          <img src="/images/maldives/01.jpg" alt="Ladakh" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0.5rem' }} />
        </div>
        <img src="/images/maldives/02.jpg" alt="Destinations" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0.5rem' }} />
        <img src="/images/maldives/03.jpg" alt="Stays" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0.5rem' }} />
        <img src="/images/maldives/04.jpg" alt="Activity" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0.5rem' }} />
        <div style={{ position: 'relative' }}>
          <img src="/images/maldives/05.jpg" alt="Sightseeing" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0.5rem' }} />
      ...
      <div style={{ padding: '1rem' }}>
        <h1 style={{ fontSize: '2rem', fontWeight: 'bold' }}>Magical Maldives Honeymoon with Water Villa Stay</h1>
        <hr />
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', margin: '1rem 0' }}>
          <span style={{ background: '#ffc107', color: '#333', padding: '0.25rem 0.75rem', borderRadius: '0.5rem', fontWeight: 'bold' }}>4D/3N</span>
