...
const DubaiHero: React.FC = () => {
  return (
    <div style={{ fontFamily: 'sans-serif' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '0.5rem', padding: '1rem' }}>
        <div style={{ gridColumn: '1 / 2', gridRow: '1 / 3' }}>
          <img src="/images/dubai/01.jpg" alt="Ladakh" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0.5rem' }} />
        </div>
        ...
        <img src="/images/dubai/06.jpg" alt="Destinations" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0.5rem' }} />
      ...
      <div style={{ padding: '1rem' }}>
        <h1 style={{ fontSize: '2rem', fontWeight: 'bold' }}> Dubai Dream Tour with Desert Safari & Burj Khalifa</h1>
        <hr />
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', margin: '1rem 0' }}>
          <span style={{ background: '#ffc107', color: '#333', padding: '0.25rem 0.75rem', borderRadius: '0.5rem', fontWeight: 'bold' }}>5D/4N</span>
          <span>5 Days / 4 Nights</span>
          <span> Dubai City</span>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ textAlign: 'right' }}>
            <p style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>INR 41,000 <span style={{ fontSize: '1rem', color: 'gray', textDecoration: 'line-through' }}>INR 45,000</span></p>
